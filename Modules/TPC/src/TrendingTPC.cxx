...
///
/// \file    TrendingTPC.cxx
/// \author  Cindy Mordasini
/// \author  Marcel Lesch
///

#include "TPC/TrendingTPC.h"
#include "QualityControl/QcInfoLogger.h"
#include "QualityControl/DatabaseInterface.h"
#include "QualityControl/MonitorObject.h"
#include "QualityControl/Reductor.h"
#include "../src/RootClassFactory.h"
...
{
void TrendingTPC::configure(std::string name, o2::configuration::ConfigurationInterface& config)
{
  mConfig = TrendingTaskConfig(name, config);
}

void TrendingTPC::initialize(Trigger, framework::ServiceRegistry& services)
{
...
void TrendingTPC::update(Trigger, framework::ServiceRegistry&)
{
  trendValues();
...
void TrendingTPC::finalize(Trigger, framework::ServiceRegistry&)
{
  storePlots();
  storeTrend();
}

void TrendingTPC::storeTrend()
{
